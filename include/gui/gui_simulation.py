...
class simulationFrame(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        layers_l = tk.Label(
            net_canvas, text="Layers:", bg=net_canvas["bg"], fg=parent.theme.selected_fg
        )
        ...
        create_button = tk.Button(
            net_canvas,
            text="Create Network",
            command=lambda: self.gen_create_box(int(layers.get())),
        )
        ...
        train_button = tk.Button(
            net_canvas, text="Training Setup", command=lambda: self.gen_train_box()
        )
        ...
        start_l = tk.Label(
            self, text="Start Point:", bg=net_canvas["bg"], fg=parent.theme.selected_fg
        )
        ...
        end_l = tk.Label(
            self, text="End Point:", bg=net_canvas["bg"], fg=parent.theme.selected_fg
        )
        ...
        visual_button = tk.Button(
            net_canvas,
            text="Visualize",
            command=lambda: self.network.export_predictions(
        ...
        inf_button = tk.Button(
            net_canvas, text="Inference", command=lambda: self.gen_inference_box()
        )
